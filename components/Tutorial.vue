    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">
          Hello! my name is <b>Lucas Leite</b>
        </h2>
        <p class="mt-3 text-gray-600">
          <a
            ...
            >lucasleite.bv@gmail.com</a
          ><br />
        </p>
        <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
          React protfoilo :
          <a
            href="https://baizidmdashadzzaman.com/"
            target="_blank"
            class="text-green-500 hover:underline"
            >baizidmdashadzzaman.com</a
          ><br />
          Next protfoilo :
          <a
            href="https://baizidmdashadzzaman.vercel.app/"
            target="_blank"
            class="text-green-500 hover:underline"
            >baizidmdashadzzaman.vercel.app</a
          ><br />
          Next protfoilo :
          <a
            href="http://asadzaman0167.herokuapp.com/"
            target="_blank"
            class="text-green-500 hover:underline"
            >asadzaman0167.herokuapp.com</a
          ><br />
          Nuxt protfoilo :
          <a
            href="https://baizidmdashadzzaman-nuxt.vercel.app/"
            target="_blank"
            class="text-green-500 hover:underline"
            >baizidmdashadzzaman-nuxt.vercel.app</a
          ><br />
        </p>
      </div>
